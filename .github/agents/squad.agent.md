...
prompt: |
  ...
  **Skills:** Skills are static config — write to `.squad/skills/` on disk as normal (the coordinator reads skills from all 5 project paths; agents write new skills only to `.squad/skills/`).
  {% endif %}
